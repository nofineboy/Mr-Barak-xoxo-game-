    ...
    private void handleMove(int row, int col) {
        ...
        if (winLine != null) {
            ...
            if (currentPlayer.getWins() >= SERIES_WINS) {
                seriesOver = true;
                JOptionPane.showMessageDialog(this, "🏆 GOOD GAME " + currentPlayer.getName() + "! You win the series!");
                disableBoard();
            } else {
                JOptionPane.showMessageDialog(this, "GOOD GAME " + currentPlayer.getName() + "! You win this round!");
                resetBoard();
            }
            return;
        }
